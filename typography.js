module.exports = ({ theme }) => ({
    DEFAULT: {
        css: {
            ...
            '--tw-prose-links-underline': theme('colors.lime.500 / 0.3'),
            ...
            '--tw-prose-invert-links-hover': theme('colors.lime.500'),
            '--tw-prose-invert-links-underline': theme('colors.lime.500 / 0.3'),
